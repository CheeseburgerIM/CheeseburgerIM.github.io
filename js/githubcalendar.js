            ...
            for (var item of git_positionplusdata) {
                ...
                if (0 < lenthx && lenthx < lineminwitdh) {
                    if (0 < lenthy && lenthy < lineminwitdh) {
                        ...
                        git_x = event.clientX - 620;
                        git_y = event.clientY - 225;
...
(function(){var git_user = 'CheeseburgerIM';
    var github_container = document.getElementById('github_container');
    var github_loading = document.getElementById('github_loading');
    var git_orange = ['#e4dfd7', '#f9f4dc', '#f7e8aa', '#f7e8aa', '#f8df72', '#fcd217', '#fcc515', '#f28e16', '#fb8b05', '#d85916', '#f43e06'];
    var git_purple = ['#ebedf0', '#fdcdec', '#fc9bd9', '#fa6ac5', '#f838b2', '#f5089f', '#c4067e', '#92055e', '#540336', '#48022f', '#30021f',];
    var git_green = ['#ebedf0', '#D6E685', '#D6E685', '#8CC665', '#8CC665', '#44A340', '#44A340', '#44A340', '#1E6823', '#1E6823', '#1E6823'];
